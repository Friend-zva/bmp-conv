...
def output_test(arr_data, labels, title, name, dir_to_save):
    create_boxplot(arr_data, labels, title, name, dir_to_save)
    create_bar(arr_data, labels, title, name, dir_to_save)
